...
class UpdateAccompagnementWidget extends StatefulWidget {
  const UpdateAccompagnementWidget({
    super.key,
    this.nomAcc,
    this.nomPorteurProjet,
    this.prenomPoteurProjet,
    this.amount,
    this.statut,
    this.paiementDate,
    required this.accId,
  ...
  final String? nomAcc;
  final String? nomPorteurProjet;
  final String? prenomPoteurProjet;
  final double? amount;
  final String? statut;
  final String? paiementDate;
  final String? accId;
  ...
  State<UpdateAccompagnementWidget> createState() =>
      _UpdateAccompagnementWidgetState();
}

class _UpdateAccompagnementWidgetState extends State<UpdateAccompagnementWidget>
    with TickerProviderStateMixin {
  late UpdateAccompagnementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateAccompagnementModel());
