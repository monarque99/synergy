...
class CreateAccompagnementWidget extends StatefulWidget {
  const CreateAccompagnementWidget({super.key});

  @override
  State<CreateAccompagnementWidget> createState() =>
      _CreateAccompagnementWidgetState();
}

class _CreateAccompagnementWidgetState extends State<CreateAccompagnementWidget>
    with TickerProviderStateMixin {
  late CreateAccompagnementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccompagnementModel());

    _model.projectNameTextController ??= TextEditingController();
    _model.projectNameFocusNode ??= FocusNode();

    _model.porteurNameTextController ??= TextEditingController();
    _model.porteurNameFocusNode ??= FocusNode();

    _model.porteurPRENameTextController ??= TextEditingController();
    _model.porteurPRENameFocusNode ??= FocusNode();

    _model.amountTextController ??= TextEditingController();
    _model.amountFocusNode ??= FocusNode();

    _model.linkcontartTextController ??= TextEditingController();
                              ...
                              children: [
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  focusNode: _model
                                                      .porteurPRENameFocusNode,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        'Prénom porteur de projet ',
                                                    hintText:
                                                        'Entrer la valeur',
                                                    hintStyle: FlutterFlowTheme
                                                            .of(context)
                                ...
                                FlutterFlowCalendar(
                                  ...
                                  onChange: (DateTimeRange? newSelectedDate) {
                                    setState(() => _model.startDateSelectedDay =
                                        newSelectedDate);
                                  },
                                ...
                                FlutterFlowCalendar(
                                  ...
                                  rowHeight: 35.0,
                                  onChange: (DateTimeRange? newSelectedDate) {
                                    setState(() => _model.endAtSelectedDay =
                                        newSelectedDate);
                                  },
                                  titleStyle: FlutterFlowTheme.of(context)
                                      .headlineSmall
                                          ...
                                          onPressed: () async {
                                            _model.apiResultf28 =
                                              ...
                                              accompagnementLastName: _model
                                                  .porteurPRENameTextController
                                                  .text,
                                              accompagnementProjectName: _model
                                                  .projectNameTextController
                                                  .text,
                                              paymentDate: _model
